...
public abstract class AsyncTask<Param, Update, Result> {
    ...
    private static class HandlerPoster extends Handler {
        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what) {
                case AsyncTask.MULTI_ASYNC_TASK_UPDATE:
                    result.onUpdate();
                    break;
                case AsyncTask.MULTI_ASYNC_TASK_RESULT:
                    result.onResult();
                    break;
            }
        }
    ...
    private class TaskExecutor implements Runnable {
         ...
         * @param params
         */
		public TaskExecutor(AsyncTask<Param, Update, Result> mTask, Param... params) {
            super();
            this.mTask = mTask;
            this.mParams = params;
        }
