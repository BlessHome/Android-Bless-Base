 ...
 * 
 * 
 * <br>ViewPorter.from(button).ofScreen().divWidth(2).commit();	<font color="#BF9660">//宽度变为屏幕的二分之一</font>
 * <br>ViewPorter.from(button).of(viewGroup).divHeight(2).commit();	<font color="#BF9660">////高度变为viewGroup的二分之一</font>
 * <br>ViewPorter.from(button).div(2).commit();	<font color="#BF9660">////宽度和高度变为屏幕的四分之一</font>
 * <br>ViewPorter.from(button).of(this).fillWidth().fillHeight().commit();	<font color="#BF9660">////宽度和高度铺满Activity</font>
 * <br>ViewPorter.from(button).sameAs(imageView).commit();	<font color="#BF9660">////button的宽度和高度和imageView一样</font>
 */
