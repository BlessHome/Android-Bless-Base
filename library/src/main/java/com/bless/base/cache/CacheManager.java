...
public class CacheManager {
    ...
    private CacheManager(File cacheDir, long max_size, int max_count) {
        ...
        mCache = new CacheSettings(cacheDir, max_size, max_count);
    }
    ...
    public <T> ArrayList<T> getAsArrayList(String key) {
        ...
        if(data != null) {
            ...
            try {
                bais = new ByteArrayInputStream(data);
                ois = new ObjectInputStream(bais);
                ArrayList e = (ArrayList)ois.readObject();
                list = e;
                return list;
            } catch (Exception e) {
                e.printStackTrace();
